...
Usage:
    graphify bot anomaly-scan [--repo PATH] [--focus "area or subsystem"]
"""
...
PROMPT = """\
You are auditing this codebase for anomalies and risks. You have graphify's
...
def main() -> int:
    ...
    try:
        ...
        with common.Task("anomaly-scan", repo, args.graphify_bin, need, args.skip_preflight) as t:
