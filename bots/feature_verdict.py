...
Usage:
    graphify bot feature-verdict "<feature description>" [--repo PATH]
    graphify bot feature-verdict --from-file spec.md [--repo PATH]
"""
...
generically. Use graphify's MCP tools: memory_search to load the project's
...
def main() -> int:
    ...
    try:
        need = {"claude session connects", "graphify MCP server"}
        with common.Task("feature-verdict", repo, args.graphify_bin, need, args.skip_preflight) as t:
