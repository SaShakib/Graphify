...
Usage:
    graphify bot test-writer <symbol-or-file> [--repo PATH] [--write]
"""
...
PROMPT = """\
Write test cases for the target below. First use the graphify MCP tools:
...
def main() -> int:
    ...
    try:
        ...
        with common.Task("test-writer", repo, args.graphify_bin, need, args.skip_preflight) as t:
